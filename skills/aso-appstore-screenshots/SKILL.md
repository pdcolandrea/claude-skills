...
1. Get a Google AI API key from https://aistudio.google.com/apikey
2. Register the server with the Claude Code CLI:
   claude mcp add -s user -e GEMINI_API_KEY=your-api-key-here gemini -- npx -y @houtini/gemini-mcp
3. Restart Claude Code
4. Run this skill again

See: https://www.npmjs.com/package/@houtini/gemini-mcp for setup instructions.
```
...
```bash
SKILL_DIR="${CLAUDE_PLUGIN_ROOT:+$CLAUDE_PLUGIN_ROOT/skills/aso-appstore-screenshots}"; SKILL_DIR="${SKILL_DIR:-$HOME/.claude/skills/aso-appstore-screenshots}" && \
